 ...
 */
var Task = ClassManager.define('Task', {
	/**
	 ...
	 * Execute this task.
	 * 
	 * Note that toggling manualOverride only matters if this task contains subtasks.
	 * 
	 * When manualOverride is toggled to true, this task is executed asap and any subtasks it contains won't be deferred. Instead they are run back-to-back
	 * until done.
	 * 
	 ...
	 * 
	 * @return {Boolan} True if complete, false otherwise
	 */
	isComplete: function() {
